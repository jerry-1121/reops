...
#   url2 = 'ping -w 6 -c 5 -i 3 wechat.9client.com'
    err = """curl 'https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=62086a86-4b8b-457f-8428-865e9a56bc99\' -H \'Content-Type: application/json\' -d \'{"msgtype": "text","text": {"content": "德勤服务进程出现异常情况\n请引起注意,请及时排出故障"} }'"""
